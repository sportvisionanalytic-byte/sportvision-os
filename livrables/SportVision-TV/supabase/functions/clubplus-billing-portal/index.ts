...
//
// Fix du 17/08/2026 (audit complet Club+, bouton "Gérer mon abonnement" enfin
// câblé côté front) : CONNECT_URL -> CLUBPLUS_URL — même bug de domaine hérité
// que create-clubplus-subscription-checkout, corrigé en même temps.
...
serve(async (req) => {
  ...
  try {
    ...
    const portalSession = await stripe.billingPortal.sessions.create({
      ...
      return_url: `${clubplusUrl}/clubplus`,
    });
