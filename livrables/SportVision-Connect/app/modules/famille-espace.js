...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.fam-badge-warn{background:color-mix(in srgb,#b56a00 16%,transparent);color:#b56a00}',
      ...
      '.fam-badge-muted{background:#eef1f7;color:var(--muted)}',
      ...
      '.fam-legal-text{font-size:12.5px;color:var(--text);background:var(--bg,#f4f6fa);border-radius:8px;padding:10px 12px;margin:8px 0;white-space:pre-wrap;max-height:220px;overflow-y:auto}',
