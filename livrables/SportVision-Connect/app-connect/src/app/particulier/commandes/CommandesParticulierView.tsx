    ...
    <div className="flex flex-col gap-6 animate-sv-in">
      ...
      {orders !== null && visible.length === 0 && (
        <div className="flex flex-col items-center gap-3 rounded-sv-card border border-dashed border-border-strong bg-surface p-8 text-center">
          ...
          {orders.length === 0 && (
            <Link href="/particulier/prestations" className="mt-1 rounded-sv bg-sv-gradient px-4 py-2.5 font-sora text-[14px] font-semibold text-white hover:brightness-[1.12]">
