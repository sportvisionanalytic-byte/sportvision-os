// Classes partagées entre les écrans du tunnel unifié "Demande d'ouverture Club+"
// (src/app/signup/request/*) — reprend exactement les tokens utilisés par
// src/app/auth/login/page.tsx pour rester visuellement cohérent avec les écrans d'accès.
