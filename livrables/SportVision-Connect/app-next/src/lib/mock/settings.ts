...
export const mockNotifications: Record<string, AppNotification[]> = {
  "org-fcf": [
    ...
    { id: "notif-3", userId: "user-sophie", organizationId: "org-fcf", category: "contracts", title: "Avenant Club+ Performance à signer", body: "Votre avenant 2026-2027 attend votre signature Youtrust.", targetHref: "/contracts", isPinned: false, isCritical: false, createdAt: "2026-08-07T16:00:00.000Z" },
