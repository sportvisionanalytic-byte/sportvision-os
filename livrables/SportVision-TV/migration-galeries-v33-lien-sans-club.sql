-- ═══════════════════════════════════════════════════════════════════════════════
-- LOT 1c — Enregistrer un lien de vente sur une galerie sans club
-- ═══════════════════════════════════════════════════════════════════════════════
--
-- Trois corrections, aucune règle de prix ni de permission touchée :
--   1. l'absence de club n'est plus prise pour l'absence d'album ;
--   2. sans club, aucun produit de catalogue n'est créé ;
--   3. le type de l'offre est enregistré sur l'offre, puisqu'elle peut n'avoir aucun produit
--      pour le lui dire.
--
-- La réconciliation des offres (migration v22) et la protection des offres déjà vendues sont
-- reprises telles quelles : une offre vendue puis retirée de l'écran est désactivée, jamais
-- supprimée, pour que son chiffre d'affaires reste attribué.
