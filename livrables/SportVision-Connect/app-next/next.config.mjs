...
// complet). Reproduit indépendamment par quatre audits du 31/08/2026 (Finance/Contrats/Sponsors sur
// /auth/login ; Organisation/Équipe via Playwright, pageerror "Evaluating a string as JavaScript
// violates ... script-src" ; Auth/Signup/Onboarding ; Messages/Notifications/Validations — Club+
// n'avait jamais reçu ce correctif avant cette nuit, contrairement à app-connect).
