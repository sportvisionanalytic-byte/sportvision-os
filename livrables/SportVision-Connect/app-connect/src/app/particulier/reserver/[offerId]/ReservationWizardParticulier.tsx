  ...
  return (
    <div className="mx-auto flex max-w-[640px] flex-col gap-6">
      <div className="flex flex-col gap-2">
        <Link href="/particulier/prestations" className="flex items-center gap-2 self-start text-[14px] font-medium text-text-tertiary hover:text-text lg:text-[13px]">
          ...
          <div className="flex flex-col gap-4 animate-sv-in">
              ...
              <div className="flex flex-col gap-3">
                ...
                {modeLivraisonMontage === "rushs_decoupes" ? (
                  <div className="flex flex-col gap-2">
                    ...
                    />
                    <span className="text-[14px] leading-relaxed text-text-tertiary lg:text-[12px]">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {touched && !dureeValid && nombreMatchsLienNum && !lienMatchUrl.trim() && (
                        <span className="text-[14px] text-danger lg:text-[12px]">Lien(s) requis.</span>
                      )}
                    </div>
                    {lienMatchMax != null && nombreMatchsLienNum != null && nombreMatchsLienNum > lienMatchMax && (
                      <span className="text-[14px] leading-relaxed text-attente lg:text-[12px]">
            ...
            {isMontageCompilation && (
              <div className="flex flex-col gap-3 border-t border-border pt-4">
                ...
                <span className="-mt-2 text-[14px] leading-relaxed text-text-tertiary lg:text-[12px]">
          ...
          <div className="flex flex-col gap-4 animate-sv-in">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <PaymentChoice
                ...
                sub="Partagez le coût via un paiement collectif."
            ...
            {paiementMode === "collectif" && (
              <div className="flex items-start gap-2.5 rounded-sv border border-attente/40 bg-attente-bg px-4 py-3.5">
                ...
                <span className="text-[14px] leading-relaxed text-text-secondary lg:text-[12.5px]">
                  Votre demande sera tout de même enregistrée au statut « En validation ». Créez ensuite un
                  paiement collectif depuis « Voir mes commandes » pour partager le coût.
                </span>
              </div>
            )}
            ...
            {(montagePctApplicable || monthlyPctApplicable || agentDiscount.monthlyUsedThisPeriod) && (
              <div className="flex flex-col gap-2.5 rounded-sv border border-[rgba(140,169,255,.35)] bg-[rgba(79,125,255,.08)] p-3.5">
                <span className="flex items-center gap-2 font-sora text-[14px] font-semibold text-text lg:text-[13.5px]">
                ...
                {monthlyPctApplicable ? (
                  <label className="flex items-start gap-2.5 text-[14px] leading-relaxed text-text-secondary lg:text-[12.5px]">
                    <input
                      type="checkbox"
                  ...
                  agentDiscount.monthlyUsedThisPeriod && (
                    <span className="text-[13px] text-text-faint lg:text-[12px]">Remise mensuelle Agent déjà utilisée cette période.</span>
                  )
                )}
              </div>
            )}
            ...
            {touched && waiverNeeded && !retractationRenoncee && <span className="text-[14px] text-danger lg:text-[12px]">Cette case est requise pour continuer.</span>}
            ...
            {touched && !cgvAcceptee && <span className="text-[14px] text-danger lg:text-[12px]">L&apos;acceptation des CGV est requise.</span>}
        ...
        {step === 4 && result && (
          <div className="flex flex-col items-center gap-4 py-4 text-center animate-sv-in">
            ...
            {paiementMode === "seul" && modePaiementChoisi === "carte" && busy && (
              <span className="text-[14px] text-text-tertiary lg:text-[13px]">Redirection vers le paiement sécurisé…</span>
            )}
