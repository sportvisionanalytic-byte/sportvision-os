-- ═══════════════════════════════════════════════════════════════════════════════
-- Couverture SportVision des séances + une séance d'entraînement appartient à UNE saison, pas à « une saison active quelque part »
-- ═══════════════════════════════════════════════════════════════════════════════
--
...
select 'OK — couverture des seances visible au calendrier' as verdict;
