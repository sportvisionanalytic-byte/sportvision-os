...
// Écran « module verrouillé » — voir ACTIONS.md § 26. Affiché sur toute route de ce module dont
// `canAccess` retourne faux. Composant propre au module Prestations (voir aussi
// src/components/content/LockedModule.tsx pour la Bibliothèque) : chaque module garde sa propre
// copie pour ne jamais dépendre d'un fichier partagé entre agents.
export function ServicesLockedModule() {
